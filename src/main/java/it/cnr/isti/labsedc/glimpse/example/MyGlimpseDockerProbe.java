...
public class MyGlimpseDockerProbe extends GlimpseAbstractProbe {
	...
	public MyGlimpseDockerProbe(Properties settings) {
		super(settings);
	}
	...
	private void generateAndSendExample_GlimpseBaseEvents_EventMachineInformationPayload() {
		...
		DebugMessages.print(System.currentTimeMillis(), 
				MyGlimpseDockerProbe.class.getSimpleName(),
		...
		message = new GlimpseBaseEventMachineInformation<String>(
			...
			try {
				...
				DebugMessages.println(System.currentTimeMillis(), MyGlimpseDockerProbe.class.getSimpleName(),
...
//		return ((int)(value * 1000) / 10.0);
	...
	private void generateAndSendExample_GlimpseBaseEvents_SmartBuildingPayload() {
		...
		DebugMessages.ok();
		DebugMessages.print(System.currentTimeMillis(), MyGlimpseDockerProbe.class.getSimpleName(),"Creating GlimpseBaseEventSB message");
	...
	private void generateAndSendExample_GlimpseBaseEvents_FaceRecognitionPayload() {
		DebugMessages.print(System.currentTimeMillis(), MyGlimpseDockerProbe.class.getSimpleName(),"Creating GlimpseBaseEventFaceRecognition message");
